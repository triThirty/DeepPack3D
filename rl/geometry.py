...
class Cuboid:
    ...
    def intersect(self, other, edge=False):
        if edge:
            return (
                ...
                and (self.back <= other.front and self.front >= other.back)
    ...
    def contain(self, other):
        return (
            ...
            and (self.back <= other.back and self.front >= other.front)
    ...
    def split(self, other, maximal=True):
        ...
        if maximal:
            if self.left < other.left:
                cuboids.append(
                    Cuboid(self.left, y, z, other.left - self.left, height, depth)
                )
            if self.right > other.right:
                cuboids.append(
                    Cuboid(other.right, y, z, self.right - other.right, height, depth)
                )
            if self.bottom < other.bottom:
                cuboids.append(
                    Cuboid(x, self.bottom, z, width, other.bottom - self.bottom, depth)
                )
            if self.top > other.top:
                cuboids.append(
                    Cuboid(x, other.top, z, width, self.top - other.top, depth)
                )
            if self.back < other.back:
                cuboids.append(
                    Cuboid(x, y, self.back, width, height, other.back - self.back)
                )
            if self.front > other.front:
                cuboids.append(
                    Cuboid(x, y, other.front, width, height, self.front - other.front)
                )
        else:
            if self.left < other.left:
